...
type Order struct {
	...
	Status         int       `gorm:"column:status;type:int(11);NOT NULL" json:"status"`      // 订单状态：0：未支付，2支付中,4:已支付,6已取消
	...
	OutTradeNo     string    `gorm:"column:out_trade_no;type:varchar(512);NOT NULL" json:"out_trade_no"`   // 商家订单号
}
